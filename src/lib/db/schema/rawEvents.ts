...
export const insertRawEventSchema = createInsertSchema(rawEvents).omit(timestamps);
export const insertRawEventParams = baseSchema.extend({
...
export type CompleteRawEvent = Awaited<ReturnType<typeof getRawEvents>>["rawEvents"][number];
