...
export const insertScheduleSchema = createInsertSchema(schedules).omit(timestamps);
...
export type CompleteSchedule = Awaited<ReturnType<typeof getSchedules>>["schedules"][number];
